...
Void Main_obj::main( ){
{
		...
		HX_STACK_LINE(30)
		::haxe::Log_obj::trace((HX_CSTRING("s1 ") + ::Std_obj::string(true)),hx::SourceInfo(HX_CSTRING("Main.hx"),30,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(31)
		::haxe::Log_obj::trace((HX_CSTRING("s2 ") + ::Std_obj::string(::example::Config_obj::s2)),hx::SourceInfo(HX_CSTRING("Main.hx"),31,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(32)
		...
		HX_STACK_LINE(33)
		::haxe::Log_obj::trace((HX_CSTRING("s4 ") + true),hx::SourceInfo(HX_CSTRING("Main.hx"),33,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(36)
		...
		HX_STACK_LINE(38)
		::haxe::Log_obj::trace((HX_CSTRING("b ") + ::Std_obj::string(config->get_b())),hx::SourceInfo(HX_CSTRING("Main.hx"),38,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(39)
		::haxe::Log_obj::trace((HX_CSTRING("c ") + ::Std_obj::string(config->get_c())),hx::SourceInfo(HX_CSTRING("Main.hx"),39,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(40)
		::haxe::Log_obj::trace((HX_CSTRING("d ") + ::Std_obj::string(config->get_d2())),hx::SourceInfo(HX_CSTRING("Main.hx"),40,HX_CSTRING("Main"),HX_CSTRING("main")));
		HX_STACK_LINE(41)

...
Array< ::haxe::StackItem > Stack_obj::callStack( ){
	HX_STACK_PUSH("Stack::callStack","/usr/lib/haxe/std/haxe/Stack.hx",46);
	HX_STACK_LINE(60)
...
::String Stack_obj::toString( Array< ::haxe::StackItem > stack){
	HX_STACK_PUSH("Stack::toString","/usr/lib/haxe/std/haxe/Stack.hx",131);
...
{
		HX_STACK_PUSH("Stack::itemToString","/usr/lib/haxe/std/haxe/Stack.hx",140);
		HX_STACK_ARG(b,"b");
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(140)
		{
